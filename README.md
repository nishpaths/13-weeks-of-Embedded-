...
- I used ChatGPT as a tutor — to explain concepts and guide debugging — not to hand me finished code (asked to give pseudocode a lot) or answers (well, at least most of the time). I also gave it the STM32 datasheet, so it's easier for me to look into and see where I need to make changes whenever I'm configuring my pins.
